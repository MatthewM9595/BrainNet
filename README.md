...
Infinte canvas /n
    ...
    - Allowing to attach audio files but to have them stored in a folder for organistion.
Allowing the creation of new folders.
Allowing the deletion of folders.
Allowing backgrounds of the canvas to be changed to any colour.
